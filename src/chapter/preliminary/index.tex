...
\begin{proof}
  ...
  であるから，\(\mat{\Lambda}=\diag(\lambda_1,\dots,\lambda_n)\)とおくと\(\mat{A}\mat{P}=\mat{P}\mat{\Lambda}\)，\(\mat{A}=\mat{P}\mat{\Lambda}\mat{P}^{-1}\)となる（ただし，\(\mat{P}\)の逆行列が存在することは\cref{proposition:basis_and_matrix}による）．
\end{proof}
