...
\begin{definition}{\(\Lebesgue{p}\)空間}{Lp_space}\index{Lpkukan@\(\Lebesgue{p}\)空間}
  ...
  \[
    \vnorm{f}_p = \pqty*{\int_\Omega\abs{f(x)}^p\intd{x}}^{1/p}
  \]
  の値が有限であるものの全体集合を\(\Lebesgue{p}(\Omega)\)とおく．このとき，ほとんどいたるところ等しい関数を同一視すれば，\(\Lebesgue{p}(\Omega)\)は\(\vnorm{\holder}_p\)をノルムとしてバナッハ空間になる．
