...
\begin{note}
  \cref{definition:sequence_converge}より，\(n\to\infty\)のとき\(x_n\to\alpha\iff d(x_n,\alpha)\to 0\)である．
\end{note}
...
\begin{proof}
  ...
  集合\(A_n=\Set{\vect{y}\in C\given\vnorm{\vect{y}-\vect{x}}^2\leq\delta^2+1/n}\)（\(n=1,2,\dotsc\)）は\(n\)の値によらず空でない．
