...
\begin{proof}
  ...
  集合\(A_n=\Set{\vect{y}\in C\given\vnorm{\vect{y}-\vect{x}}^2\leq\delta^2+1/n}\)は\(n\in\numset{N}\)の値によらず空でない．
  ...
  \[
    \vnorm{\vect{a}_m-\vect{a}_n}^2 \leq 2\pqty*{\delta^2+\frac{1}{m}}+2\pqty*{\delta^2+\frac{1}{n}}-4\delta^2
