...
\begin{figure}[htbp]
  \centering
  \includegraphics{figure/riemann_sum.pdf}
...
\begin{figure}[htbp]
  \begin{minipage}{0.5\linewidth}
    \centering
    \includegraphics{figure/complex_convergence.pdf}
    \caption{\(z_n\to 0\)（\(n\to\infty\)）の様子．}
    \label{figure:sequence_converge}
  \end{minipage}%
  \begin{minipage}{0.5\linewidth}
    \centering
    \includegraphics{figure/func_convergence.pdf}
...
\begin{figure}[htbp]
  \begin{minipage}{0.5\linewidth}
    \centering
    \includegraphics{figure/convex.pdf}
    \caption{\(\numset{R}^2\)の凸集合．}
  \end{minipage}%
  \begin{minipage}{0.5\linewidth}
    \centering
    \includegraphics{figure/non_convex.pdf}
...
\begin{figure}[htbp]
  \begin{minipage}{0.5\linewidth}
    \centering
    \includegraphics{figure/haar_scaling}
    \caption{Haarのスケーリング関数．}
  \end{minipage}%
  \begin{minipage}{0.5\linewidth}
    \centering
    \includegraphics{figure/meyer_scaling}
