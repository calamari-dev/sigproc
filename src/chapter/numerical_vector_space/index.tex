...
\begin{proof}
  任意の\(\vect{x},\vect{y}\in H\)に対して\(\innerp{\vect{x}+\vect{y}}{G(\vect{x}+\vect{y})}=\innerp{\vect{x}}{G(\vect{y})}+\innerp{\vect{y}}{G(\vect{x})}=\innerp{G(\vect{x})}{\vect{y}}+\innerp{\vect{y}}{G(\vect{x})}=0\)だから，
