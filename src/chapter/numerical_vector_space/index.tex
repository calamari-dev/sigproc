...
\(\mat{U}=\htrps{\inlinevec{\vect{e}_1 & \cdots & \vect{e}_n}}\)，\(\mat{\Lambda}=\begin{bsmallmatrix}\imat_m & \\ & \zmat_{n-m}\end{bsmallmatrix}=\diag(1,\dots,1,0,\dots,0)\)とおく．
このとき，任意の\(\vect{x}=\trps{\inlinevec{x_1 & \cdots & x_n}}\in\numset{C}^n\)に対して
\[
