...
\begin{definition}{短時間フーリエ変換}{discrete_stft}\index{たんじかんふーりえへんかん@短時間フーリエ変換}\index{まどかんすう@窓関数}\index{STFT|see{短時間フーリエ変換}}\index{Sw@\(\stft{w}\)}
  ...
  また，\(w\)を\(\stft[L]{w}x\)の\termdef{窓関数}（window function）という．
\end{definition}
