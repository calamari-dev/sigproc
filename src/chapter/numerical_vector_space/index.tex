...
\begin{proof}
  ...
  \(\vect{g}\neq\zvec\)ならば\(h\)の値が十分小さいとき\(\increment\epsilon(\vect{a})<0\)である．つまり，\(\htrps{\mat{A}}\mat{A}\vect{a}\neq\htrps{\mat{A}}\vect{b}\)ならば\(\epsilon(\vect{a})\)は関数\(\epsilon\)の最小値ではない．
\end{proof}
