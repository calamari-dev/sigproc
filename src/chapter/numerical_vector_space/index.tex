...
\cref{section:dft}から，本書の主題である信号解析に入っていく．その手始めに，いまから扱う信号とは何か明確にしておく．
...
しかし，\(\mapset{I}{O}\)の元すべてに共通する性質は普通そう多くない．
...
これは対応づけ\(x=\seq{x_n}_{n=0}^{N-1}\longleftrightarrow\vect{x}=\trps{\matrice{x_0 & \cdots & x_{N-1}}}\)を考えれば明らかであろう．
