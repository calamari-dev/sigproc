...
\begin{figure}[htbp]
  \begin{minipage}{\linewidth/2}
    \centering
    \includegraphics[width=45mm]{figures/building.png}
  \end{minipage}%
  \begin{minipage}{\linewidth/2}
    \centering
    \includegraphics{figures/2ddft.pdf}
  \end{minipage}
  \caption{モノクロ画像の2次元離散フーリエ変換．振幅に直線がいくつか現れている．}
\end{figure}
