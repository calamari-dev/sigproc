...
実際に\(\abs{\hat{x}_k}\)を計算すると，\cref{figure:frequency_domain}のようになる．
...
\cref{figure:frequency_domain}を見ると，\SI{250}{Hz}周辺に1つめのピークが現れている．これは音声\(\vect{x}\)の\termdef{基本周波数}\index{きほんしゅうはすう@基本周波数}（fundamental frequency）と呼ばれる量で，
