...
\cref{proposition:eigenspaces_disjointness}によれば，\(\mat{A}\)の固有値\(\lambda_1\)，\(\lambda_2\)が\(\lambda_1\neq\lambda_2\)を満たすとき，固有空間の和\(E_{\lambda_1}(\mat{A})+E_{\lambda_2}(\mat{A})\)は直和である．
