...
\begin{proof}
  ...
  \[
    \ran*{T}{\argmin_{\vect{x}\in\numset{K}^p}\vnorm{T(\vect{x})-\vect{y}}} = \argmin_{\vect{z}\in\img T}\vnorm{\vect{z}-\vect{y}}
...
\begin{example}
  ...
  \(\vect{v}_1=\trps{\rowvect{4 & 1 & 2}}\)，\(\vect{v}_2=\trps{\rowvect{0 & 3 & 2}}\)とおくと\(\colsp\mat{A}=\spannedby\Set{\vect{v}_1,\vect{v}_2}\)である．

  \(P=\proj_{\colsp\mat{A}}\)とおく．\(\Set{\vect{v}_1,\vect{v}_2}\)に\nameref{xr-proposition:gram_schmidt}を適用すると
...
\begin{figure}[htbp]
  ...
  \caption{\(\vect{v}_1\)，\(\vect{v}_2\)と\(P(\vect{y})=\mat{A}\vect{x}\)の様子．}
\end{figure}
