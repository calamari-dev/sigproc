...
また，\(\increment\vect{x}=-t(\htrps{\mat{A}}\mat{A}\vect{x}_0-\htrps{\mat{A}}\vect{y})\)（\(t>0\)）のとき
\[
  \increment\epsilon(\vect{x}_0) = -2t\vnorm{\htrps{\mat{A}}\mat{A}\vect{x}_0-\htrps{\mat{A}}\vect{y}}^2+\vnorm{\mat{A}\increment\vect{x}}^2
\]
なので，\(\htrps{\mat{A}}\mat{A}\vect{x}_0=\htrps{\mat{A}}\vect{y}\)でなければ\(t\)の値を十分大きくとることで\(\increment\epsilon(\vect{x}_0)<0\)を成り立たせられる．
...
\begin{note}
  \(\numset{K}=\numset{R}\)のとき\(\increment\epsilon(\vect{x})=2\innerp{\htrps{\mat{A}}\mat{A}\vect{x}-\htrps{\mat{A}}\vect{y}}{\increment\vect{x}}+\vnorm{\mat{A}\increment\vect{x}}^2\)だから，
  \(\increment\vect{x}\)を微分小とみなせば\(\intd*{\epsilon}=2(\htrps{\mat{A}}\mat{A}\vect{x}-\htrps{\mat{A}}\vect{y})\cdot\intd*{\vect{x}}\)である．つまり，\(\htrps{\mat{A}}\mat{A}\vect{x}-\htrps{\mat{A}}\vect{y}\)は\(\epsilon(\vect{x})\)の勾配ベクトルである．
\end{note}
