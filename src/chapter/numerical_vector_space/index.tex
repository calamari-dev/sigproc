...
特に\(d=2\)のとき
\begin{align*}
  \hat{f}(\nu_1,\nu_2) &= \frac{1}{\sqrt{n_1n_2}}\sum_{x_1=0}^{n_1-1}\sum_{x_2=0}^{n_2-1}f(x_1,x_2)\napr^{-2\krez\iuni(\nu_1x_1/n_1+\nu_2x_2/n_2)} \\
  &= \sum_{x_1=0}^{n_1-1}\frac{\napr^{-2\krez\iuni\nu_1x_1/n_1}}{\sqrt{n_1}}\sum_{x_2=0}^{n_2-1}\frac{\napr^{-2\krez\iuni\nu_2x_2/n_2}}{\sqrt{n_2}}f(x_1,x_2)
\end{align*}
